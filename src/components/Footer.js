...
function Footer() {
  ...
  return (
    <div id="footer">
      ...
      {footnotesShow && (
        <>
          <p id="footnote-a"><sup>a</sup>Potential opportunity for intervention includes linkage to care or life-saving actions (i.e., recent institutional release, previous nonfatal overdose, mental health diagnosis, current treatment for substance use disorder, potential bystander present when fatal overdose occurred, and fatal drug use witnessed).</p>
          <p id="footnote-b"><sup>b</sup>Any opioid includes deaths that had at least one opioid listed as a cause of death. The "Any Opioids" category includes Illicitly manufactured fentanyls, heroin, prescription opioids, and any other opioids involved in overdose deaths.</p>
          ...
          <p id="footnote-e"><sup>e</sup>Any stimulant includes deaths that had at least one stimulant listed as a cause of death. The "Any Stimulant" category includes cocaine, methamphetamine, and any other stimulants involved in overdose deaths.</p>
          ...
          <p id="footnote-p"><sup>p</sup>Persons experiencing homelessness were those who resided in either places not designed for or ordinarily used as regular sleeping accommodations or in a supervised shelter or drop-in center designated to provide temporary living arrangements, congregate shelters, or temporary accommodations provided by a homeless shelter.  Persons experiencing housing instability are those who are not experiencing homelessness, but lack the resources or support networks to obtain or retain permanent housing and includes interrelated challenges, such as trouble paying rent, overcrowding, moving frequently, or staying with relatives.</p>
        </>
      )}
