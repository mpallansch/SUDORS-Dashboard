...
function Footer() {
  ...
  return (
    <div id="footer">
      ...
      {footnotesShow && (
        <>
          <p id="footnote-a"><sup>a</sup>Potential opportunity for intervention includes linkage to care or life-saving actions (i.e., recent release from institutional setting (&lt;1 month), prior overdose, mental health diagnosis, current treatment for substance use disorder(s), potential bystander present when fatal overdose occurred, and fatal drug use witnessed).</p>
